...
def save_checkpoint(state, filename='/home/jamal/Downloads/additional_files/checkpoint_baseline.pth.tar'):
    torch.save(state, filename)
    
file_path ='/home/jamal/Downloads/additional_files/umdfaces_batch1_ultraface_new1.csv'
...
class Male_Female_dataset(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        sample = {'image1':image1,'image2':image2, 'same' : annot}
        return sample
...
if load_net:
    net = Net().to(device)
    checkpoint = torch.load('/home/jamal/Desktop/low high image cnn/checkpoint_baseline.pth.tar')
...
train_dataloader = DataLoader(dataset,batch_size=30,sampler = SubsetRandomSampler(train_index))
